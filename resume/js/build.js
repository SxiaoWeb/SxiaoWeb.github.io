! function(t) {
    ...
    t.exports = i("skills-1", function(t, e) {
        ...
        var s = this,
            ...
            o = t.len,
            l = "";
        return l += ' <div class="skills"> <div class="skills_top"> <div class="top_con"> <div class="skills_title"> <h3>技能展示</h3> <p>喜欢原生js，喜欢研究各种新技术</p> </div> <div class="top_detail clearfix"> <div class="left"> ', n(a.pageArr, function(t, e) {
    ...
    s(9), t.exports = i("case", function(t, e) {
        ...
        var s = this,
            ...
            l = "";
        return l += '<div class="case" style="display:none" > <div class="casecon"> <div class="case1 clearfix"> <div class="bts"> <h2 class="bt">前端知识汇总&案例展示</h2> </div> <div class="case_main clearfix"> <div class="case_left"> <div class="case_list_main"> ', n(a, function(t, e) {
    ...
    var i = s(3);
    t.exports = i("footer", '<div class="footer"> <div class="footcon clearfix"> <div class="footleft"> <p>孙 骁</p> <p>电话：158-1095-4324</p></p>邮箱：sxiaoweb@163.com</p> </div> </div> </div>')
}, function(t, e, s) {
    function i(t, e) {
